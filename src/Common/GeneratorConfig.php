...
class GeneratorConfig
{
    ...
    public function loadNamespaces(CommandData &$commandData)
    {
        ...
        $this->nsService = config('infyom.laravel_generator.namespace.service', 'App\Services').$prefix;
        $this->nsResource = config('infyom.laravel_generator.namespace.resource', 'App\Resources').$prefix;
    ...
    public function loadPaths()
    {
        ...
        $this->pathService = config(
            'infyom.laravel_generator.path.service',
            app_path('Services/')
        ).$prefix;

        $this->pathResource = config(
                'infyom.laravel_generator.path.resource',
                app_path('Resources/')
            ).$prefix;
