...
use InfyOm\Generator\Generators\ApiResourceGenerator;
...
class BaseCommand extends Command
{
    ...
    public function generateAPIItems()
    {
        ...
        if (!$this->isSkip('tests') and $this->commandData->getAddOn('tests')) {
            $serviceTestGenerator = new ServiceTestGenerator($this->commandData);
    ...
    public function getOptions()
    {
        return [
            ...
            ['skip', null, InputOption::VALUE_REQUIRED, 'Skip Specific Items to Generate (migration,model,controllers,api_controller,scaffold_controller,service,requests,api_requests,scaffold_requests,routes,api_routes,scaffold_routes,views,tests,menu,dump-autoload)'],
